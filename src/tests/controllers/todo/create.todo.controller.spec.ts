...
import * as todoService from '../../../services/todo/create-todo.service.js';
import { TodoEntity } from '../../../database/entities/to-do.entity.js';
import * as jwt from './../../../auth/jwt.js';

describe('POST /todos (controller)', () => {
  afterEach(() => {
    vi.restoreAllMocks();
  });
  ...
  it('it should create a todo and return it', async () => {
    vi.spyOn(todoService, 'createTodoService').mockResolvedValue(
      todo as TodoEntity,
    );
  ...
  it('should return 400 if title is missing', async () => {
    vi.spyOn(todoService, 'createTodoService').mockRejectedValue({
